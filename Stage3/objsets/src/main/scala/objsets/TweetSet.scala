...
abstract class TweetSet {
  ...
  def max(left: Tweet, right: Tweet): Tweet =
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  //    var most = elem
  //
  //    foreach(tweet => most = max(most, tweet))
  //
  //    most
  //  }
  ...
  override def mostRetweetedAcc(othermax: Tweet): Tweet =
    left.mostRetweetedAcc(right.mostRetweetedAcc(max(othermax, elem)))
